...
В качетве полетного контролера был выбран Pixhavk v.4, т.к. он, в отличии от стандатроного на клеверах Pixracer имеет больше сигнальных портов для движков.
